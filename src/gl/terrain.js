...
void main() {
  ...
  //
  // Flat, deliberately. A speckle pass was tried and read as cloud rather than
  // sand -- value noise has the wrong statistics for a packed granular surface,
  // whose texture is really thousands of tiny shadowed spheres. Getting that
  // right means the grains themselves, not a fake on the surface underneath.
